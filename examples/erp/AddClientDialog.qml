    ...
    Column {
        ...
        Rectangle { width: parent.width; height: 56; color: "#FAFBFD"; radius: 16
            Text { anchors { left: parent.left; leftMargin: 20; verticalCenter: parent.verticalCenter }
                   text: "New client"; color: Theme.ink; font.pixelSize: 16; font.bold: true } }
        Column {
            width: parent.width; padding: 20; spacing: 12
            Column { spacing: 5; width: parent.width - 40
                Text { text: "Company name"; color: Theme.muted; font.pixelSize: 12 }
                TextField { id: fName; width: parent.width; placeholderText: "Riverside Health Partners"
            ...
            Row { spacing: 12; width: parent.width - 40
                Column { spacing: 5; width: (parent.width - 12) / 2
                    Text { text: "Industry"; color: Theme.muted; font.pixelSize: 12 }
                    TextField { id: fIndustry; width: parent.width; placeholderText: "Healthcare"
                                background: Rectangle { radius: 8; color: Theme.field } } }
                Column { spacing: 5; width: (parent.width - 12) / 2
            ...
            Row { spacing: 12; width: parent.width - 40
                Column { spacing: 5; width: (parent.width - 12) / 2
                    Text { text: "City"; color: Theme.muted; font.pixelSize: 12 }
                    TextField { id: fCity; width: parent.width; placeholderText: "Portland"
                                background: Rectangle { radius: 8; color: Theme.field } } }
                Column { spacing: 5; width: (parent.width - 12) / 2
                    Text { text: "State"; color: Theme.muted; font.pixelSize: 12 }
                    TextField { id: fState; width: parent.width; placeholderText: "OR"
                                background: Rectangle { radius: 8; color: Theme.field } } } }
            Row { spacing: 12; anchors.right: parent.right; anchors.rightMargin: 20
                ...
                Rectangle { width: 120; height: 40; radius: 10; color: Theme.accent
                    Text { anchors.centerIn: parent; text: "Add client"; color: "white"; font.pixelSize: 14; font.bold: true }
                    MouseArea { anchors.fill: parent; onClicked: {
                        var id = store.addClient(fName.text, fIndustry.text, fCity.text, fState.text, fPhone.text)
                        fName.text = ""; fIndustry.text = ""; fCity.text = ""; fState.text = ""; fPhone.text = ""
